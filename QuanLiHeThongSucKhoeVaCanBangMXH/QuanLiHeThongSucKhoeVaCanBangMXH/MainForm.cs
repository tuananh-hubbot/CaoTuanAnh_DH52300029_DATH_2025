...
namespace QuanLiHeThongSucKhoeVaCanBangMXH
{
    public partial class MainForm : Form
    {
        ...
        {
            DialogResult KetQua = MessageBox.Show("Bạn có chắc muốn thoát chương trình không?", "Xác nhận thoát", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        ...
        private void btnKiemTraTang_Click(object sender, EventArgs e)
        {
            ...
            if (count == 0)
            {
                MessageBox.Show($"Tầng {k} không có node nào.", "Kết quả", MessageBoxButtons.OK, MessageBoxIcon.Information);
            ...
            else
            {
                ...
                MessageBox.Show($"Tầng {k} có {count} node(s): {names}", "Kết quả", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
